...
namespace KlondikeTest {
    public class SolverTest {
        ...
        private SolveResult SolveGame(
            ...
            m_Output.WriteLine(board.GetDeal());
            m_Output.WriteLine(string.Empty);
            m_Output.WriteLine(board.ToString());
            ...
            m_Output.WriteLine(board.MovesMadeOutput);
            m_Output.WriteLine(result.Result.ToString());
            m_Output.WriteLine($"({board.MovesMade},{board.CardsInFoundation},{board.TimesThroughDeck})");
        ...
        public void Game_Solve_Minimal_05_80_1() {
            SolveResult result = SolveGame(
                ...
                52,
                true,
                "011061012013133132131021051014053042134023043033032062031034022052024041054064063044121122123124111112113114101102103104091092093094081082083084071072073074",
                1,
                10,
                250,
                10000
        ...
        public void Game_Solve_Minimal_14_139_1() {
            SolveResult result = SolveGame(
                ...
                52,
                false,
                "073041124122091063054034021032132093111031043064013022131103123092113074083072044114062102024134082053011033042012014104084023094112121081051071052133061101",
                1,
                10,
                250,
                200000
        ...
        public void Game_Solve_Minimal_15_132_1() {
            SolveResult result = SolveGame(
                ...
                52,
                false,
                "031133054011034033084074013043104083113014052122022053114041081062021071012024111093064032123132121072063112134131101091044103082092094124102073042023061051",
                1,
                10,
                250,
                300000
